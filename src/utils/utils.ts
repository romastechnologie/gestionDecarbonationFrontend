...
const getUrlApiForFilesWithFolder = (dossier: string | null, nomFichier: string | null) => {
  if (dossier) {
...
const monSwal = (
    ...
    btnAcceptColor = "btn btn-danger",
    btnCancelText = "Annuler",
    cancelMessage = "L'opération a été annulée"
...
function openNewWindow(data: any, folderName: any) {
  openAndPrint(getUrlApiForFilesWithFolder(folderName, data + ".pdf"));
}

export {
  getDatePlusXDays, removeModalBackdrop, suppression, separateur, hideModal,
  getAssetPath, format_Date, showModal, format_date, success, error, destroyTinyMCE,
  getUrlApiForFiles, getUrlApiForProductFiles, isNumber, monSwal, getCurrentDate, openNewWindow, formatMontant, watch
};
